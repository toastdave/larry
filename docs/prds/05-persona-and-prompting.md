...
- Completed: chat now surfaces persona trust cues and Vega freshness expectations directly in the product UI instead of relying on the in-thread reply alone
